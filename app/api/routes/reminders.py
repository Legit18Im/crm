    ...
    try:
        ...
        if not reminders:
            try:
                ...
                logger.info("[REMINDER] Demo fallback reminders created for UI visibility.")
            except Exception as seed_err:
                logger.warning("[REMINDER] Demo seed failed (non-critical): %s", seed_err)
        # ─────────────────────────────────────────────────────────────────────
        ...
        logger.error("[REMINDER] get_due_reminders failed: %s", e)
        return []
...
def dismiss_reminder(
    ...
    try:
        ...
        logger.error("[REMINDER] dismiss failed: %s", e)
...
def complete_reminder(
    ...
    try:
        ...
        logger.error("[REMINDER] mark_done failed: %s", e)
